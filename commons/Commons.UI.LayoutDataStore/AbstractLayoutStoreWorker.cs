...
namespace Commons.UI.LayoutDataStore
{
    ...
    /// </summary>
    public abstract class AbstractLayoutStoreWorker : ILayoutStoreWorker
    {
        ...
        public AbstractLayoutStoreWorker(ILayoutDataStorePathFactory layoutDataStorePathFactory)
        {
        ...
        public AbstractLayoutStoreWorker(ILayoutDataStorePathFactory layoutDataStorePathFactory, string onlyFileName,
                                 params ILayoutDataStore[] stores)
            : this(layoutDataStorePathFactory, onlyFileName, (IList<ILayoutDataStore>) stores)
        {
        }
        ...
        public AbstractLayoutStoreWorker(ILayoutDataStorePathFactory layoutDataStorePathFactory, INamableControl form,
                                 params ILayoutDataStore[] stores)
