...
//        private int _childCount;
		...
		private Dock TabStripPlacement
		{
			...
			{
				Dock dock = Dock.Top;
				ExtendedTabControl templatedParent = base.TemplatedParent as ExtendedTabControl;
		...
		private Size MeasureHorizontal(Size availableSize)
		{
			...
			{
				ExtendedTabItem tabItem = InternalChildren[i] as ExtendedTabItem;
		...
		public Rect MakeVisible(Visual visual, Rect rectangle)
		{
			...
			ExtendedTabControl ic = ItemsControl.GetItemsOwner(this) as ExtendedTabControl;
